# Lab C1 · Use Your Project in the 6-Agent Software Factory
...
```bash
cd ~/Projects/factory/lab_c1
git clone https://github.com/<user>/<project>.git c1-project
```
...
cp ~/Projects/actual-software/software-factory-intensive/activities/labs/C1/docs/PROJECT_MANIFEST.md ~/Projects/factory/lab_c1/c1-project/docs/
