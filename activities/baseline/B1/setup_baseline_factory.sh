...
B1_DIR="$SFI_DIR/activities/baseline/B1"
...
cp "$B1_DIR/gascity/step_0/packs/city.toml" "$FACTORY_DIR/city.toml"
rsync -av "$B1_DIR/gascity/step_0/packs/" "$FACTORY_DIR/packs/actual/"
