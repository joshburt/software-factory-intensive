# Software Factory Intensive - Baseline - B1
...
## Script Setup (Alternative)

Instead of following the manual steps above, you can run the setup script:

```bash
bash ~/Projects/actual-software/software-factory-intensive/activities/baseline/B1/setup_baseline_factory.sh
```
