...
1. **Where does the ledger live?** Options: new table, denormalized column, materialized view. This is the architectural decision the Architect will resolve in `docs/adr/0001-loyalty-points-storage.md`.
